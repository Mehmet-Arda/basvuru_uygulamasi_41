...
class AdminApprovedApplicationsScreen extends StatefulWidget{
  late Map adminInfo;
  AdminApprovedApplicationsScreen(this.adminInfo);
  @override
  _AdminApprovedApplicationsScreenState createState()=>_AdminApprovedApplicationsScreenState(adminInfo);

}


class _AdminApprovedApplicationsScreenState extends State<AdminApprovedApplicationsScreen> {
  late Map adminInfo;
  ...
  _AdminApprovedApplicationsScreenState(this.adminInfo);
    ...
    return DefaultTabController(
      ...
      child: Scaffold(
        appBar:AppBar(
          ...
          title: Text("Onaylanan Başvurular",style: TextStyle(fontFamily: "Recursive",fontSize: 25),),
          centerTitle: true,
          elevation: 4,
            ...
            StreamBuilder<QuerySnapshot>(
              ...
              builder: (BuildContext context, AsyncSnapshot<QuerySnapshot> snapshot) {
                ...
                snapshot.data?.docs.forEach((element){
                  ...
                  if(element.get("approval_status")=="Onaylandı"){
                    sayac++;
            ...
            StreamBuilder<QuerySnapshot>(
              ...
              builder: (BuildContext context, AsyncSnapshot<QuerySnapshot> snapshot) {
                ...
                snapshot.data?.docs.forEach((element){
                  ...
                  if(element.get("approval_status")=="Onaylandı" && element.get("application_type")=="Dgs"){
                    sayac++;
            ...
            StreamBuilder<QuerySnapshot>(
              ...
              builder: (BuildContext context, AsyncSnapshot<QuerySnapshot> snapshot) {
                ...
                snapshot.data?.docs.forEach((element){
                  ...
                  if(element.get("approval_status")=="Onaylandı"&& element.get("application_type")=="Çap"){
                    sayac++;
            ...
            StreamBuilder<QuerySnapshot>(
              ...
              builder: (BuildContext context, AsyncSnapshot<QuerySnapshot> snapshot) {
                ...
                snapshot.data?.docs.forEach((element){
                  ...
                  if(element.get("approval_status")=="Onaylandı"&& element.get("application_type")=="Yatay Geçiş"){
                    sayac++;
            ...
            StreamBuilder<QuerySnapshot>(
              ...
              builder: (BuildContext context, AsyncSnapshot<QuerySnapshot> snapshot) {
                ...
                snapshot.data?.docs.forEach((element){
                  ...
                  if(element.get("approval_status")=="Onaylandı" && element.get("application_type")=="Yaz Okulu"){
                    sayac++;
            ...
            StreamBuilder<QuerySnapshot>(
              ...
              builder: (BuildContext context, AsyncSnapshot<QuerySnapshot> snapshot) {
                ...
                snapshot.data?.docs.forEach((element){
                  ...
                  if(element.get("approval_status")=="Onaylandı"&& element.get("application_type")=="İntibak"){
                    sayac++;
